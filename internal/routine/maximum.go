...
// Maximum is a binary function that selects max elements. It propagates NaNs.
func Maximum(dt dtype.DType) math.BinaryFunc {
	switch dt {
	case dtype.Bool:
	...
	case dtype.Float32:
		return func(_ []int, d, l, r unsafe.Pointer) {
			*(*float32)(d) = float32(stdmath.Max(float64(*(*float32)(l)), float64(*(*float32)(r))))
		}
	case dtype.Float64:
		return func(_ []int, d, l, r unsafe.Pointer) {
			*(*float64)(d) = stdmath.Max(*(*float64)(l), *(*float64)(r))
		}
