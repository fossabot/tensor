...
func binaryConvert(ddt, ldt, rdt core.DType, op func(core.DType) BinaryFunc) BinaryFunc {
	...
	case core.Int8:
		...
		case ldt == core.Int8 && rdt != core.Int8:
			return func(d, l, r unsafe.Pointer) { fn(d, l, rdt.AsInt8Ptr(r)) }
		case ldt != core.Int8 && rdt == core.Int8:
			return func(d, l, r unsafe.Pointer) { fn(d, ldt.AsInt8Ptr(l), r) }
		case ldt != core.Int8 && rdt != core.Int8:
			return func(d, l, r unsafe.Pointer) {
				fn(d, ldt.AsInt8Ptr(l), rdt.AsInt8Ptr(r))
			}
		}
	case core.Int16:
		switch {
		case ldt == core.Int16 && rdt != core.Int16:
			return func(d, l, r unsafe.Pointer) { fn(d, l, rdt.AsInt16Ptr(r)) }
		case ldt != core.Int16 && rdt == core.Int16:
			return func(d, l, r unsafe.Pointer) { fn(d, ldt.AsInt16Ptr(l), r) }
		case ldt != core.Int16 && rdt != core.Int16:
			return func(d, l, r unsafe.Pointer) {
				fn(d, ldt.AsInt16Ptr(l), rdt.AsInt16Ptr(r))
			}
		}
	case core.Int32:
		switch {
		case ldt == core.Int32 && rdt != core.Int32:
			return func(d, l, r unsafe.Pointer) { fn(d, l, rdt.AsInt32Ptr(r)) }
		case ldt != core.Int32 && rdt == core.Int32:
			return func(d, l, r unsafe.Pointer) { fn(d, ldt.AsInt32Ptr(l), r) }
		case ldt != core.Int32 && rdt != core.Int32:
			return func(d, l, r unsafe.Pointer) {
				fn(d, ldt.AsInt32Ptr(l), rdt.AsInt32Ptr(r))
			}
		}
	case core.Int64:
		switch {
	...
	case core.Uintptr:
		...
		case ldt == core.Uintptr && rdt != core.Uintptr:
			return func(d, l, r unsafe.Pointer) { fn(d, l, rdt.AsUintptrPtr(r)) }
		case ldt != core.Uintptr && rdt == core.Uintptr:
			return func(d, l, r unsafe.Pointer) { fn(d, ldt.AsUintptrPtr(l), r) }
		case ldt != core.Uintptr && rdt != core.Uintptr:
			return func(d, l, r unsafe.Pointer) {
				fn(d, ldt.AsUintptrPtr(l), rdt.AsUintptrPtr(r))
			}
		}
	case core.Float32:
		switch {
